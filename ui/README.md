...
`VantageUI-v<major.minor.patch>`, for example `VantageUI-v1.44.80`. All XML and
...
candidate the tag is `vantage-ui-v1.44.80`. Verify public asset sizes and
...
as `uifiles\VantageUI-v1.44.80`. Shared managed-version state is stored beside
