...
`VantageUI-v<major.minor.patch>`, for example `VantageUI-v1.44.69`. All XML and
...
candidate the tag is `vantage-ui-v1.44.69`. Verify public asset sizes and
...
as `uifiles\VantageUI-v1.44.69`. Shared managed-version state is stored beside
