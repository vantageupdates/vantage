...
`VantageUI-v<major.minor.patch>`, for example `VantageUI-v1.44.70`. All XML and
...
candidate the tag is `vantage-ui-v1.44.70`. Verify public asset sizes and
...
as `uifiles\VantageUI-v1.44.70`. Shared managed-version state is stored beside
