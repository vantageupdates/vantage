...
`VantageUI-v<major.minor.patch>`, for example `VantageUI-v1.44.58`. All XML and
...
candidate the tag is `vantage-ui-v1.44.58`. Verify public asset sizes and
...
as `uifiles\VantageUI-v1.44.58`. Shared managed-version state is stored beside
