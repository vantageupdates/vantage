...
try {
    ...
    & $Python -m pytest -q tests/test_ui_skin_updater.py tests/test_ui_skin_versioned.py tests/test_ui_skin_windows_permissions.py tests/test_ui_skin_package.py tests/test_ui_skin_app.py tests/test_ui_skin_layout.py tests/test_ui_skin_client_contract.py tests/test_ui_health_palette.py tests/test_ui_cast_palette.py tests/test_build_ui_release_policy.py
